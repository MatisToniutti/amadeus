...
import torch
from transformers import Gemma3ForConditionalGeneration, BitsAndBytesConfig, AutoProcessor
import uvicorn
import os
...
async def load_model():
    ...
    print("--- Modèle gemma-3-4b-it chargé et prêt ! ---")
